...
describe('withdrawal and Mark Exit flows', () => {
  ...
  it('separates partial and full withdrawal reasons and explains KYC demo allowance', async () => {
    ...
    expect(container.textContent).toContain('Mark your exit from Pied Piper before applying for a full withdrawal.')
    expect(container.querySelector('#claim-employment')).toBeNull()
    expect(container.textContent).not.toContain('Needs Verification')
    expect(container.textContent).not.toContain('Maximum for this request')
