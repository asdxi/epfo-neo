...
describe('withdrawal and Mark Exit flows', () => {
  ...
  it('separates partial and full withdrawal reasons and explains KYC demo allowance', async () => {
    ...
    expect(container.textContent).toContain('an active employment cannot be used for full settlement.')
    expect(container.querySelector('#claim-employment')).toBeNull()
    expect(container.textContent).toContain('Currently employed · no unemployment period recorded')
