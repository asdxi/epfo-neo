...
export const demoNotices: MemberNotice[] = [
  { id: 'kyc-verification-reminder', title: 'Keep your Aadhaar-linked mobile number active', body: 'Aadhaar OTP verification is needed for selected member services.', publishedOn: '2026-08-28', isNew: true, attachment: 'pdf', attachmentLabel: 'View notice' },
